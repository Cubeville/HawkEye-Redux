...
public enum Item {
	...
	SIGN_POST(63, "standing_sign", Attribute.ATTACHABLE_TOP | Attribute.BREAKS_FALLING, Sign.class),
	...
	WALL_SIGN(68, "wall_sign", Attribute.ATTACHABLE_SIDE | Attribute.BREAKS_FALLING, Sign.class),
	...
	private Item(int id, String name, int flags) {
		this(id, name, flags, null);
	}

	private Item(int id, String name, Class<? extends NBTSerializable> dataClass) {
		this(id, name, 0, dataClass);
	}

	private Item(int id, String name, int flags, Class<? extends NBTSerializable> dataClass) {
		this.id = (short) id;
		this.name = name;
		this.flags = flags;
