...
public enum Item {
	...
	TRAPPED_CHEST(146),
	GOLD_PLATE(147, Attribute.ATTACHABLE_TOP | Attribute.BREAKS_FALLING),
	IRON_PLATE(148, Attribute.ATTACHABLE_TOP | Attribute.BREAKS_FALLING),
	REDSTONE_COMPARATOR_ON(149, Attribute.ATTACHABLE_TOP | Attribute.BREAKS_FALLING),
	REDSTONE_COMPARATOR_OFF(150, Attribute.ATTACHABLE_TOP | Attribute.BREAKS_FALLING),
	DAYLIGHT_SENSOR(151, Attribute.BREAKS_FALLING),
	REDSTONE_BLOCK(152),
	QUARTZ_ORE(153),
	HOPPER(154),
	QUARTZ_BLOCK(155),
	QUARTZ_STAIRS(156),
	ACTIVATOR_RAIL(157, Attribute.ATTACHABLE_TOP | Attribute.BREAKS_FALLING),
	DROPPER(158),
	STAINED_CLAY(159),
	WHEAT_BLOCK(170),
	CARPET(171, Attribute.ATTACHABLE_TOP | Attribute.BREAKS_FALLING),
	HARDENED_CLAY(172),
	COAL_BLOCK(173),
