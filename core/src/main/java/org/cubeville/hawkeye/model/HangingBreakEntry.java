...
public class HangingBreakEntry extends AbstractEntityEntry implements Modifiable {

	public HangingBreakEntry(DatabaseEntry entry) {
		super(entry.getAction(), entry);
	}

	public HangingBreakEntry(UUID player, Location location, Entity entity) {
